...
import {TwitterIcon, GithubIcon, LinkedInIcon, PinterestIcon, DribbbleIcon, WhatsApp, Instagram, MoonIcon, SunIcon} from './Icons'
    ...
    className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
      ...
      <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
        ...
        <nav className="flex items-center justify-center flex-wrap">
            <motion.a href="https://www.linkedin.com/in/chandan-neralgi-b4bb51210/" target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a href="https://github.com/chandanneralgi" target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a href="https://wa.me/9148273454/?text=I%20would%20like%20to%20connect%20with%20you." target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a href="https://twitter.com/chandanneralgi" target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a href="https://www.instagram.com/chandan_neralgi/" target={"_blank"}
            whileHover={{y:-2 }}
            whileTap={{scale:0.9}}
            className="w-6 ml-3"
            >
